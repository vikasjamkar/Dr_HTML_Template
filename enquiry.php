...
<div class="contact-page-area1 wow zoomIn w3l-enquiry" data-wow-duration="800ms" data-wow-delay="1000ms">
        <div class="container">
            <div class="row">
               <div id="FeedbackForm">
<p class="mb-4 ">We welcome any question or requirment you may have for our products</p>
...
<div class="LeftForm">
    <div class"col-12 col-md-6 col-lg-6" >
            <input maxlength="100" name="CompanyName" size="30" class="inputField" placeholder="Name of Company :*" tabindex="1" required>
     </div>
     <div class"col-12 col-md-6 col-lg-6" >
          <input maxlength="100" name="contact_person" size="30" type="tel" class="inputField" placeholder="Name of Contact Person :*" tabindex="2" required>
          <input maxlength="100" name="email" size="29" class="inputField" type="email" placeholder="Email :*" tabindex="4" required>
     </div>
