...
<?php include "header.php" ?>
    ...
    <div id="wowslider-container1">
      ...
      <div class="ws_bullets">
        <div>
          <a href="#" title="slider1"><img src="data1/tooltips/slider1.jpg" alt="slider1"/>1</a>
          <a href="#" title="slider2"><img src="data1/tooltips/slider2.jpg" alt="slider2"/>2</a>
          <a href="#" title="slider3"><img src="data1/tooltips/slider3.jpg" alt="slider3"/>3</a>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-12">
          <div class="section-title text-center title-gap" style="margin-top:55px">
      ...
      <div class="container">
       <div class="col-12">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 mt-4 mt-lg-0 gallery-grids wow animate fadeInRight animated"
              data-wow-duration="1s" data-wow-delay="1.2s">
              <div class="w3ls-hover">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 mt-4 mt-lg-4 gallery-grids wow animate fadeInRight animated"
              data-wow-duration="1s" data-wow-delay="1.2s">
              <div class="w3ls-hover">
    ...
    <div id="gallery" class="jarallax w3ls-section gallery">
      ...
      <div class="gallery-w3lsrow">
        <div class="container">
          <div class="row">
            <div
              class="col-lg-3 col-md-6 col-sm-4 col-xs-6 gallery-grids"
            >
              <div>
                <a
  ...
  window.onscroll = function() {
    ...
    if (scrollPercentage > 5) {
        fixedButton.style.display = 'block';  // Show the button when scrolled 5%
    } else {
        fixedButton.style.display = 'none';   // Hide the button otherwise
    }
};
