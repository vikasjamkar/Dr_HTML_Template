...
<div class="demo-gallery">
            ...
            <ul id="lightgallery" class="list-unstyled row">
				...
				<!-- <li class="col-xs-4 col-sm-4 col-md-3" data-responsive="images/ronch-3.jpg"  data-src="images/ronch-3.jpg" data-sub-php="<h4>Ronch</h4>">
					<iframe width="260" height="200" src="https://www.youtube.com/embed/MjlpKcOA4bQ"
				  ...
				  <li class="col-xs-4 col-sm-4 col-md-3" data-responsive="images/ronch-3.jpg"  data-src="images/ronch-3.jpg" data-sub-php="<h4>Ronch</h4>">
					<iframe width="260" height="200" src="https://www.youtube.com/embed/7ssgv2sfCjA"
							title="YouTube video player" frameborder="0"
							allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
							allowfullscreen></iframe>
				  </li>
				  ...
				  <li class="col-xs-4 col-sm-4 col-md-3" data-responsive="images/ronch-3.jpg"  data-src="images/ronch-3.jpg" data-sub-php="<h4>Ronch</h4>">
					<iframe width="260" height="200" src="https://www.youtube.com/embed/WquQY3Iu5Ys"
							title="YouTube video player" frameborder="0"
							allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
							allowfullscreen></iframe>
				  </li>
				  ...
				  <li class="col-xs-4 col-sm-4 col-md-3" data-responsive="images/ronch-3.jpg"  data-src="images/ronch-3.jpg" data-sub-php="<h4>Ronch</h4>">
					<iframe width="260" height="200" src="https://www.youtube.com/embed/_8Xvkdf_5gQ"
							title="YouTube video player" frameborder="0"
							allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
							allowfullscreen></iframe>
				  </li>
				  ...
				  <li class="col-xs-4 col-sm-4 col-md-3" data-responsive="images/ronch-3.jpg"  data-src="images/ronch-3.jpg" data-sub-php="<h4>Ronch</h4>">
					<video width="260" height="200px" controls>
